...
- **Batch Download Automation**: Download multiple Lark/Feishu documents automatically
  ...
  - **Configurable file organization** (available in Options → Download):
    - **Subfolder organization**: Creates timestamped folder (e.g., `wiki-export-2026-02-27-143022/`)
    - **Nested folders**: Mirrors wiki structure with parent-child folder hierarchy
  ...
  **Example folder structure with nested folders enabled:**
  ```
  Downloads/
